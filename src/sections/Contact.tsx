        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="max-w-2xl lg:max-w-5xl mx-auto">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white underline decoration-blue-500 ">Contact <span className="text-blue-500">us</span></h1>
              ...
              <div className="divide-y divide-gray-200 dark:divide-neutral-800">
                ...
                <div className=" flex gap-x-7 py-6">
                  ...
                  <div className="grow">
                    ...
                    <a className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="mailto:support@caridosen.my.id">
