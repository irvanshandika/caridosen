...
NREUM.loader_config = { accountID: "4477971", trustKey: "4477971", agentID: "601476005", licenseKey: "NRJS-431f8412c51216674ac", applicationID: "601476005" };
NREUM.info = { beacon: "bam.nr-data.net", errorBeacon: "bam.nr-data.net", licenseKey: "NRJS-431f8412c51216674ac", applicationID: "601476005", sa: 1 }; /*! For license information please see nr-loader-spa-1.260.1.min.js.LICENSE.txt */
(() => {
  var e,
    t,
    r = {
      234: (e, t, r) => {
        "use strict";
        r.d(t, { P_: () => m, Mt: () => b, C5: () => s, DL: () => w, OP: () => O, lF: () => D, Yu: () => _, Dg: () => v, CX: () => c, GE: () => E, sU: () => I });
        var n = r(8632),
          i = r(9567);
        const o = {
            beacon: n.ce.beacon,
        ...
        const f = "[data-nr-mask]",
          h = () => {
            const e = {
              ...
              mask_input_options: { color: !1, date: !1, "datetime-local": !1, email: !1, month: !1, number: !1, range: !1, search: !1, tel: !1, text: !1, time: !1, url: !1, week: !1, textarea: !1, select: !1, password: !0 },
            };
            return {
              feature_flags: [],
      ...
      385: (e, t, r) => {
        "use strict";
        r.d(t, { FN: () => u, IF: () => f, LW: () => s, Nk: () => p, Tt: () => d, _A: () => a, iS: () => c, il: () => i, sK: () => g, ux: () => l, v6: () => o, w1: () => h });
        var n = r(7894);
      ...
      8632: (e, t, r) => {
        ...
        function s() {
          let e = a();
          return e.o || (e.o = { ST: n._A.setTimeout, SI: n._A.setImmediate, CT: n._A.clearTimeout, XHR: n._A.XMLHttpRequest, REQ: n._A.Request, EV: n._A.Event, PR: n._A.Promise, MO: n._A.MutationObserver, FETCH: n._A.fetch }), e;
        }
        function c(e, t) {
          let r = a();
      ...
      7144: (e, t, r) => {
        "use strict";
        r.d(t, { Ef: () => o, J0: () => f, Mi: () => l, Vb: () => a, Ye: () => c, fm: () => u, i9: () => s, pB: () => h, t9: () => i, u0: () => d });
        var n = r(7056);
      ...
      3112: (e, t, r) => {
        ...
        function u(e, t) {
          ...
          return { originalTimestamp: e, correctedTimestamp: r, timestampDiff: e - r, originTime: o.sK, correctedOriginTime: t.correctedOriginTime, originTimeDiff: Math.floor(o.sK - t.correctedOriginTime) };
        }
      },
      3614: (e, t, r) => {
        "use strict";
        r.d(t, { BST_RESOURCE: () => i, END: () => s, FEATURE_NAME: () => n, FN_END: () => u, FN_START: () => c, PUSH_STATE: () => d, RESOURCE: () => o, START: () => a, c: () => l });
          ...
          E ||
            ...
            void 0 === e.api &&
              (e.api = (function (e, t) {
                ...
                function _(t, r, n, o) {
                  const a = (0, i.C5)(e);
                  return null === r ? delete a.jsAttributes[t] : (0, i.CX)(e, { ...a, jsAttributes: { ...a.jsAttributes, [t]: r } }), S(w, n, !0, o || null === r ? "session" : void 0)(t, r);
                }
                function x() {}
                g.forEach((e) => {
                  p[e] = S(w, e, !0, "api");
      ...
      3325: (e, t, r) => {
        ...
        const n = {
          ...
          i = { [n.pageViewEvent]: 1, [n.pageViewTiming]: 2, [n.metrics]: 3, [n.jserrors]: 4, [n.ajax]: 5, [n.sessionTrace]: 6, [n.pageAction]: 7, [n.spa]: 8, [n.softNav]: 9, [n.sessionReplay]: 10 };
      },
    },
    n = {};
  function i(e) {
      ...
      class Y {
        ...
        generateTracePayload(e) {
          ...
          return (
            ...
            ((e.sameOrigin && !this.excludeNewrelicHeader()) || (!e.sameOrigin && this.isAllowedOrigin(e) && this.useNewrelicHeaderForCors())) && (d.newrelicHeader = this.generateTraceHeader(a, c, u, n, i, o)),
            d
          );
        }
      ...
      class me extends b {
        ...
        #o() {
          this.featAggregate
            ...
            : ((this.#i = ge.IK.FULL),
              this.#s(t.pB.API),
              this.recorder && this.recorder.parent.mode !== ge.IK.FULL && ((this.recorder.parent.mode = ge.IK.FULL), this.recorder.stopRecording(), this.recorder.startRecording(), (this.abortHandler = this.recorder.stopRecording)));
        }
      }
      var ve = i(6216);
      class be extends b {
        ...
        constructor(e, t) {
          ...
          const c = new s.Yu.MO((e, t) => {
            ...
            u = (0, v.D)(
              (e) => {
                (0, N.p)("newUIEvent", [e], void 0, this.featureName, this.ee), c.observe(document.body, { attributes: !0, childList: !0, subtree: !0, characterData: !0 });
              },
              100,
              { leading: !0 }
            );
            ...
            r.sort((e, t) => a.p[e.featureName] - a.p[t.featureName]),
              r.forEach((r) => {
                ...
                n.every((e) => e in this.features) ||
                  (0, e.Z)("".concat(r.featureName, " is enabled but one or more dependent features has not been initialized (").concat((0, T.P)(n), "). This may cause unintended consequences or missing data...")),
